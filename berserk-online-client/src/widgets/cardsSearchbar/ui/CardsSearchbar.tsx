    ...
    return (
        <>
            <div className={cls.CardsSearchbar}>
                ...
                {(width > 700 || isShowDropdown && cards.length) && <div
                ...
                >
                    ...
                    >
                        {findCardsStatus.isUncompleted && value
                            ? width > 700 && <ReactLoading type={'bubbles'} color={'#ffffff'} height={100} width={90} />
                            : cards.map(res =>
                                <SearchbarCardItem
                                    key={res.id}
                                    setIsSaveDisabled={setIsSaveDisabled}
                                    setModalCard={(card: CardType | null) => {
                                        setModalCard(card)
